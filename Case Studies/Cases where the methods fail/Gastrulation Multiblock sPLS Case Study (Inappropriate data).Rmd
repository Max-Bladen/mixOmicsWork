...
load('Data/rna.data.RData') # load the gastrulation data
load('Data/met.data.RData')
load('Data/acc.data.RData')

X1 <- rna.data$rna # select the five dataframes to explore
X2 <- met.data$met_genebody
X3 <- acc.data$acc_genebody
X4 <- met.data$met_promoter
X5 <- acc.data$acc_promoter
